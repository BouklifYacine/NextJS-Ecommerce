...
<h2 className='text-center text-xl md:text-3xl tracking-tight font-medium'>Nos Réseaux Sociaux </h2>
    <div className="flex flex-wrap justify-center gap-4 md:gap-6 mt-4 pb-8 mx-auto px-4">
        ...
        <Image src={Snapchat} alt="Logo Manchester City" width={45}  className="w-[35px] md:w-[45px]" />
        <Image src={Youtube} alt="Logo Manchester City" width={45}   className="w-[35px] md:w-[45px]" />
        <Image src={Twitter} alt="Logo Manchester City" width={45}   className="w-[35px] md:w-[45px]" />
        <Image src={Instagram} alt="Logo Manchester City" width={45}   className="w-[35px] md:w-[45px]" />
        <Image src={Tiktok} alt="Logo Manchester City" width={45}   className="w-[35px] md:w-[45px]" />
        <Image src={Whatsapp} alt="Logo Bayern Munich" width={45}   className="w-[35px] md:w-[45px]" />
