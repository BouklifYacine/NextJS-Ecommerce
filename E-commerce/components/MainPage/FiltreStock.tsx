...
const FiltresStock = () => {
  return (
    ...
    <Select>
        <SelectTrigger className="w-[200px] h-12  bg-gray-300 rounded-full select-trigger">
          <SelectValue placeholder="Prixxxx" className="text-red-500 text-lg font-medium" />
        </SelectTrigger>
        <SelectContent>
          <SelectGroup>
